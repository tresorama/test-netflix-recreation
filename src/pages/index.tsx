...
const DemoPagesNav = () => (
  ...
  .demoPagesNav a:visited {
    color: violet;
  }
  `}</style>
    <div className='demoPagesNav'>
      <p>Demo Pages :</p>
      <ul>
        <li><NextLink href="/photographer"><a>The Photographer</a></NextLink></li>
      </ul>
    </div>
  </>
);
...
const ChakraSection = () => (
  <ChakraUIProvider>
    <Box maxW="container.sm" m="auto" py={20}>
      ...
      <Stack spacing={8}>
        <Text>Chakra Custom Theme is found in <Code>./src/lib/chakra-ui/chakra.custom-theme.ts</Code>.</Text>
